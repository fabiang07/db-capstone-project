...
CREATE TABLE `ordermenu` (
  ...
  KEY `OrderID` (`OrderID`),
  KEY `MenuID` (`MenuID`),
  CONSTRAINT `ordermenu_ibfk_1` FOREIGN KEY (`OrderID`) REFERENCES `orders` (`OrderID`),
  CONSTRAINT `ordermenu_ibfk_2` FOREIGN KEY (`MenuID`) REFERENCES `menu` (`MenuID`)
...
-- Dump completed on 2025-08-18 13:21:26
